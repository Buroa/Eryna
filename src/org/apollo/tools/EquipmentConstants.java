...
public final class EquipmentConstants {
	...
	public static final String[] HATS = { "helm", "hood", "coif", "Coif", "hat", "partyhat", "Hat", "full helm (t)",
			"full helm (g)", "hat (t)", "hat (g)", "cav", "boater", "helmet", "mask", "Helm of neitiznot", "tiara" };
	...
	public static final String[] WEAPONS = { "scimitar", "longsword", "sword", "longbow", "shortbow", "dagger", "mace",
			...
			"javelin(p)", "knife", "knife(p)", "Longbow", "Shortbow", "Crossbow", "Karils x-bow", "Toktz-xil", "Toktz-mej",
	...
	public static final String[] BONUS_NAMES = { "Stab", "Slash", "Crush", "Magic", "Range", "Stab", "Slash", "Crush",
			"Magic", "Range", "Summoning", "Absorb Melee", "Absorb Magic", "Absorb Ranged", "Strength",
			"Range Strength", "Prayer", "Magic Damage" };
