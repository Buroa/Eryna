 ...
 * primary difference is that a reference
 * to the current context should be passed around within the server. The
 * {@link Server} should not be as it allows
 * access to some methods such as
 * {@link Server#bind(java.net.SocketAddress, java.net.SocketAddress, java.net.SocketAddress, java.net.SocketAddress)}
