 ...
 * clients synchronized with the in-game world.
 * There are two implementations distributed with Apollo:
 * {@link SequentialClientSynchronizer} which is optimized for a
 * single-core/single-processor machine and {@link ParallelClientSynchronizer}
 * which is optimized for a multi-processor/
 * multi-core machines.
 * <p>
